...
public:
  LGFX(void) {
    ...
    {                                       // Set the display panel control.
      ...
      cfg.offset_rotation  = 4;             // offset of display rotation (set 4 to get LANDSCAPE_USB_RIGHT, PORTRAIT_USB_UP, 
                                            // LANDSCAPE_USB_LEFT, PORTRAIT_USB_DOWN for lcd.setRotation(r) r=0..3)
